                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <a href="<?= base_url('menu/edit');  ?>" class="badge badge-success" name="bt_edit">Edit</a>
                                <a href="" class="badge badge-danger" name="bt_delete" data-toggle="modal" data-target="#DeleteMenuModal">Delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="MenuModalLabel">Add New</h5>
...
<div class="modal fade" id="DeleteMenuModal" tabindex="-1" role="dialog" aria-labelledby="DeleteMenuModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DeleteMenuModalLabel">Are You Sure To Delete ??</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
